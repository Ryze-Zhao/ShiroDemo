package com.zhaolearn.shirodemo1;
...
public class ShiroDemo1ApplicationTests {
    private static final transient Logger log =LoggerFactory.getLogger(ShiroDemo1ApplicationTests.class);
    @Test
    public void shiroDemo1ApplicationTests() {
