package com.zhaolearn.shirojwtredis.config;


import com.zhaolearn.shirojwtredis.common.Constant;
import com.zhaolearn.shirojwtredis.common.SerializableUtil;
import com.zhaolearn.shirojwtredis.common.StringUtil;
import com.zhaolearn.shirojwtredis.exception.MyException;
...
public class JedisUtil {
    ...
    public static Long ttl(String key) {
        ...
        try {
            ...
            throw new MyException("获取Redis键过期剩余时间ttl方法异常:key=" + key + " cause=" + e.getMessage());
        } finally {
            if(jedis != null) {
                jedis.close();
            }
